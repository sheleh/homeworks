...
def add_entries(phonebook):
    ...
    tel_number = input('please enter your telephone number: ')# прехватывать бы сообщение сразу на входу а не  после того как все введешь
...
def search_by_first_name_(phonebook):
    status = 0
    first_name = input('please enter a first name: ').lower()
